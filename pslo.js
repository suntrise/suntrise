var all = "";
var str = ""
var arra=["α","ä","á","à","ā","ā","ǎ","ǎ","ă","ă","å"]
...
function psloca() {
  ...
  str = pstype.value;
    for (let i in str) {
        ...
        if(al=="e"){
          al=arre[Math.floor(Math.random()*10)]
        }
        if(al=="E"){
        ...
        if(al=="g"){
          al=arrg[Math.floor(Math.random()*1)]
        }
        if(al=="G"){
          al=arrgg[Math.floor(Math.random()*1)]
        }
        if(al=="h"){
        ...
        if(al=="V"){
          al=arrvv[Math.floor(Math.random()*1)]
        }
        if(al=="w"){
        ...
        if(al=="y"){
          al=arry[Math.floor(Math.random()*3)]
        }
        if(al=="Y"){
        ...
        if(al=="Z"){
          al=arrzz[Math.floor(Math.random()*1)]
        }
        if(al=="\n"){
          al="<br>"
        }
